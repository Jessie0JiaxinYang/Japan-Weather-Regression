...
data = [["res", "2018", "1", "Gifu", table.iloc[19,9]],\
["com", "2018", "1", "Gifu", table.iloc[20,9]],\
["ind", "2018", "1", "Gifu", table.iloc[21,9]],\
["oth", "2018", "1", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "2", "Gifu", table.iloc[19,9]],\
["com", "2018", "2", "Gifu", table.iloc[20,9]],\
["ind", "2018", "2", "Gifu", table.iloc[21,9]],\
["oth", "2018", "2", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "3", "Gifu", table.iloc[19,9]],\
["com", "2018", "3", "Gifu", table.iloc[20,9]],\
["ind", "2018", "3", "Gifu", table.iloc[21,9]],\
["oth", "2018", "3", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "4", "Gifu", table.iloc[19,9]],\
["com", "2018", "4", "Gifu", table.iloc[20,9]],\
["ind", "2018", "4", "Gifu", table.iloc[21,9]],\
["oth", "2018", "4", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "5", "Gifu", table.iloc[19,9]],\
["com", "2018", "5", "Gifu", table.iloc[20,9]],\
["ind", "2018", "5", "Gifu", table.iloc[21,9]],\
["oth", "2018", "5", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "6", "Gifu", table.iloc[19,9]],\
["com", "2018", "6", "Gifu", table.iloc[20,9]],\
["ind", "2018", "6", "Gifu", table.iloc[21,9]],\
["oth", "2018", "6", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "7", "Gifu", table.iloc[19,9]],\
["com", "2018", "7", "Gifu", table.iloc[20,9]],\
["ind", "2018", "7", "Gifu", table.iloc[21,9]],\
["oth", "2018", "7", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "8", "Gifu", table.iloc[19,9]],\
["com", "2018", "8", "Gifu", table.iloc[20,9]],\
["ind", "2018", "8", "Gifu", table.iloc[21,9]],\
["oth", "2018", "8", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "9", "Gifu", table.iloc[19,9]],\
["com", "2018", "9", "Gifu", table.iloc[20,9]],\
["ind", "2018", "9", "Gifu", table.iloc[21,9]],\
["oth", "2018", "9", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "10", "Gifu", table.iloc[19,9]],\
["com", "2018", "10", "Gifu", table.iloc[20,9]],\
["ind", "2018", "10", "Gifu", table.iloc[21,9]],\
["oth", "2018", "10", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "11", "Gifu", table.iloc[19,9]],\
["com", "2018", "11", "Gifu", table.iloc[20,9]],\
["ind", "2018", "11", "Gifu", table.iloc[21,9]],\
["oth", "2018", "11", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2018", "12", "Gifu", table.iloc[19,9]],\
["com", "2018", "12", "Gifu", table.iloc[20,9]],\
["ind", "2018", "12", "Gifu", table.iloc[21,9]],\
["oth", "2018", "12", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "1", "Gifu", table.iloc[19,9]],\
["com", "2019", "1", "Gifu", table.iloc[20,9]],\
["ind", "2019", "1", "Gifu", table.iloc[21,9]],\
["oth", "2019", "1", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "2", "Gifu", table.iloc[19,9]],\
["com", "2019", "2", "Gifu", table.iloc[20,9]],\
["ind", "2019", "2", "Gifu", table.iloc[21,9]],\
["oth", "2019", "2", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "3", "Gifu", table.iloc[19,9]],\
["com", "2019", "3", "Gifu", table.iloc[20,9]],\
["ind", "2019", "3", "Gifu", table.iloc[21,9]],\
["oth", "2019", "3", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "4","Gifu", table.iloc[19,9]],\
["com", "2019", "4", "Gifu", table.iloc[20,9]],\
["ind", "2019", "4", "Gifu", table.iloc[21,9]],\
["oth", "2019", "4", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "5", "Gifu", table.iloc[19,9]],\
["com", "2019", "5", "Gifu", table.iloc[20,9]],\
["ind", "2019", "5", "Gifu", table.iloc[21,9]],\
["oth", "2019", "5", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "6", "Gifu", table.iloc[19,9]],\
["com", "2019", "6", "Gifu", table.iloc[20,9]],\
["ind", "2019", "6", "Gifu", table.iloc[21,9]],\
["oth", "2019", "6", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "7", "Gifu", table.iloc[19,9]],\
["com", "2019", "7", "Gifu", table.iloc[20,9]],\
["ind", "2019", "7", "Gifu", table.iloc[21,9]],\
["oth", "2019", "7", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "8", "Gifu", table.iloc[19,9]],\
["com", "2019", "8", "Gifu", table.iloc[20,9]],\
["ind", "2019", "8", "Gifu", table.iloc[21,9]],\
["oth", "2019", "8", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "9", "Gifu", table.iloc[19,9]],\
["com", "2019", "9", "Gifu", table.iloc[20,9]],\
["ind", "2019", "9", "Gifu", table.iloc[21,9]],\
["oth", "2019", "9", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "10", "Gifu", table.iloc[19,9]],\
["com", "2019", "10", "Gifu", table.iloc[20,9]],\
["ind", "2019", "10", "Gifu", table.iloc[21,9]],\
["oth", "2019", "10", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "11", "Gifu", table.iloc[19,9]],\
["com", "2019", "11", "Gifu", table.iloc[20,9]],\
["ind", "2019", "11", "Gifu", table.iloc[21,9]],\
["oth", "2019", "11", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2019", "12", "Gifu", table.iloc[19,9]],\
["com", "2019", "12", "Gifu", table.iloc[20,9]],\
["ind", "2019", "12", "Gifu", table.iloc[21,9]],\
["oth", "2019", "12", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "1", "Gifu", table.iloc[19,9]],\
["com", "2020", "1", "Gifu", table.iloc[20,9]],\
["ind", "2020", "1", "Gifu", table.iloc[21,9]],\
["oth", "2020", "1", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "2", "Gifu", table.iloc[19,9]],\
["com", "2020", "2", "Gifu", table.iloc[20,9]],\
["ind", "2020", "2", "Gifu", table.iloc[21,9]],\
["oth", "2020", "2", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "3", "Gifu", table.iloc[19,9]],\
["com", "2020", "3", "Gifu", table.iloc[20,9]],\
["ind", "2020", "3", "Gifu", table.iloc[21,9]],\
["oth", "2020", "3", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "4", "Gifu", table.iloc[19,9]],\
["com", "2020", "4", "Gifu", table.iloc[20,9]],\
["ind", "2020", "4", "Gifu", table.iloc[21,9]],\
["oth", "2020", "4", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "5", "Gifu", table.iloc[19,9]],\
["com", "2020", "5", "Gifu", table.iloc[20,9]],\
["ind", "2020", "5", "Gifu", table.iloc[21,9]],\
["oth", "2020", "5", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "6", "Gifu", table.iloc[19,9]],\
["com", "2020", "6", "Gifu", table.iloc[20,9]],\
["ind", "2020", "6", "Gifu", table.iloc[21,9]],\
["oth", "2020", "6", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "7", "Gifu", table.iloc[19,9]],\
["com", "2020", "7", "Gifu", table.iloc[20,9]],\
["ind", "2020", "7", "Gifu", table.iloc[21,9]],\
["oth", "2020", "7", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "8", "Gifu", table.iloc[19,9]],\
["com", "2020", "8", "Gifu", table.iloc[20,9]],\
["ind", "2020", "8", "Gifu", table.iloc[21,9]],\
["oth", "2020", "8", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "9", "Gifu", table.iloc[19,9]],\
["com", "2020", "9", "Gifu", table.iloc[20,9]],\
["ind", "2020", "9", "Gifu", table.iloc[21,9]],\
["oth", "2020", "9", "Gifu", table.iloc[22,9]]]
...
table=pd.read_excel(file_path,sheet_name=sheetName)
data = [["res", "2020", "10", "Gifu", table.iloc[19,9]],\
["com", "2020", "10", "Gifu", table.iloc[20,9]],\
["ind", "2020", "10", "Gifu", table.iloc[21,9]],\
["oth", "2020", "10", "Gifu", table.iloc[22,9]]]
...
data = [["res", "2020", "11", "Gifu", table.iloc[18,11]],\
["com", "2020", "11", "Gifu", table.iloc[19,11]],\
["ind", "2020", "11", "Gifu", table.iloc[20,11]],\
["oth", "2020", "11", "Gifu", table.iloc[21,11]]]
...
# CDD
table = pandas.read_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Weather Seasonality\Japan Weather\Gifu CDD.csv')
table.columns = ['date','CDD']
Output2 = pd.merge(Output2, table, how = 'inner', on = "date")
# Output2 = Output2.drop(['Other'], axis = 1)

# HDD
table = pandas.read_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Weather Seasonality\Japan Weather\Gifu HDD.csv',  error_bad_lines=False)
...
x = sm.add_constant(Output2.iloc[:,6:19]) #生成自变量
y = Output2['value']
model = sm.OLS(y, x)
result = model.fit()
result.summary()
