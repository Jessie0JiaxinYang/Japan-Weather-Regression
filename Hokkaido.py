# -*- coding: utf-8 -*-
"""
Created on Mon Feb  8 16:54:55 2021
...
data =  [["res", "2018", "1", "Hokkaido", table.iloc[19,6]],\
	     ["com", "2018", "1", "Hokkaido", table.iloc[20,6]],\
	     ["ind", "2018", "1", "Hokkaido", table.iloc[21,6]],\
	     ["oth", "2018", "1", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "2", "Hokkaido", table.iloc[19,6]],\
	    ["com", "2018", "2", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2018", "2", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2018", "2", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "3", "Hokkaido", table.iloc[19,6]],\
	    ["com", "2018", "3", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2018", "3", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2018", "3", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "4", "Hokkaido", table.iloc[19,6]],\
	    ["com", "2018", "4", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2018", "4", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2018", "4", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "5", "Hokkaido", table.iloc[19,6]],\
	    ["com", "2018", "5", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2018", "5", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2018", "5", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "6", "Hokkaido", table.iloc[19,6]],\
	    ["com", "2018", "6", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2018", "6", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2018", "6", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "7", "Hokkaido", table.iloc[19,6]],\
        ["com", "2018", "7", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2018", "7", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2018", "7", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "8", "Hokkaido", table.iloc[19,6]],\
        ["com", "2018", "8", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2018", "8", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2018", "8", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "9", "Hokkaido", table.iloc[19,6]],\
        ["com", "2018", "9", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2018", "9", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2018", "9", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "10", "Hokkaido", table.iloc[19,6]],\
        ["com", "2018", "10", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2018", "10", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2018", "10", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "11", "Hokkaido", table.iloc[19,6]],\
        ["com", "2018", "11", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2018", "11", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2018", "11", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2018", "12", "Hokkaido", table.iloc[19,6]],\
        ["com", "2018", "12", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2018", "12", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2018", "12", "Hokkaido", table.iloc[22,6]]]
...
data =  [["res", "2019", "1", "Hokkaido", table.iloc[19,6]],\
	     ["com", "2019", "1", "Hokkaido", table.iloc[20,6]],\
	     ["ind", "2019", "1", "Hokkaido", table.iloc[21,6]],\
	     ["oth", "2019", "1", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "2", "Hokkaido", table.iloc[19,6]],\
	    ["com", "2019", "2", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2019", "2", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2019", "2", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "3", "Hokkaido", table.iloc[19,6]],\
	    ["com", "2019", "3", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2019", "3", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2019", "3", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "4","Hokkaido",  table.iloc[19,6]],\
	    ["com", "2019", "4", "Hokkaido", table.iloc[20,6]],\
	    ["ind", "2019", "4", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2019", "4", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "5", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "5", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "5", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2019", "5", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "6", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "6", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "6", "Hokkaido", table.iloc[21,6]],\
	    ["oth", "2019", "6", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "7", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "7", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "7", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2019", "7", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "8", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "8", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "8", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2019", "8", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "9", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "9", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "9", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2019", "9", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "10", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "10", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "10", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2019", "10", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "11", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "11", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "11", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2019", "11", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2019", "12", "Hokkaido", table.iloc[19,6]],\
        ["com", "2019", "12", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2019", "12", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2019", "12", "Hokkaido", table.iloc[22,6]]]
...
data =  [["res", "2020", "1", "Hokkaido", table.iloc[19,6]],\
         ["com", "2020", "1", "Hokkaido", table.iloc[20,6]],\
         ["ind", "2020", "1", "Hokkaido", table.iloc[21,6]],\
         ["oth", "2020", "1", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "2", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "2", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "2", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "2", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "3", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "3", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "3", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "3", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "4", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "4", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "4", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "4", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "5", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "5", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "5", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "5", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "6", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "6", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "6", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "6", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "7", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "7", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "7", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "7", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "8", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "8", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "8", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "8", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "9", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "9", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "9", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "9", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "10", "Hokkaido", table.iloc[19,6]],\
        ["com", "2020", "10", "Hokkaido", table.iloc[20,6]],\
        ["ind", "2020", "10", "Hokkaido", table.iloc[21,6]],\
        ["oth", "2020", "10", "Hokkaido", table.iloc[22,6]]]
...
data = [["res", "2020", "11", "Hokkaido", table.iloc[18,8]],\
        ["com", "2020", "11", "Hokkaido", table.iloc[19,8]],\
	    ["ind", "2020", "11", "Hokkaido", table.iloc[20,8]],\
	    ["oth", "2020", "11", "Hokkaido", table.iloc[21,8]]]
...
import pandas
# CDD
table = pandas.read_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Weather Seasonality\Japan Weather\Hokkaido CDD.csv')
table.columns = ['date','CDD']
Output2 = pd.merge(Output2, table, how = 'inner', on = "date")

# HDD
table = pandas.read_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Weather Seasonality\Japan Weather\Hokkaido HDD.csv')
table.columns = ['date','HDD']
Output2 = pd.merge(Output2, table, how = 'inner', on = "date")
...
x = sm.add_constant(Output2.iloc[:,6:17]) #生成自变量
y = Output2['value']
model = sm.OLS(y, x)
result = model.fit()
result.summary()
