...
data = [["res", "2018", "1", "Tokyo", table.iloc[19,8]],\
["com", "2018", "1", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "1", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "1", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "2", "Tokyo", table.iloc[19,8]],\
["com", "2018", "2", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "2", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "2", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "3", "Tokyo", table.iloc[19,8]],\
["com", "2018", "3", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "3", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "3", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "4", "Tokyo", table.iloc[19,8]],\
["com", "2018", "4", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "4", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "4", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "5", "Tokyo", table.iloc[19,8]],\
["com", "2018", "5", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "5", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "5", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "6", "Tokyo", table.iloc[19,8]],\
["com", "2018", "6", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "6", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "6", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "7", "Tokyo", table.iloc[19,8]],\
["com", "2018", "7", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "7", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "7", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "8", "Tokyo", table.iloc[19,8]],\
["com", "2018", "8", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "8", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "8", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "9", "Tokyo", table.iloc[19,8]],\
["com", "2018", "9", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "9", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "9", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "10", "Tokyo", table.iloc[19,8]],\
["com", "2018", "10", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "10", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "10", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "11", "Tokyo", table.iloc[19,8]],\
["com", "2018", "11", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "11", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "11", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2018", "12", "Tokyo", table.iloc[19,8]],\
["com", "2018", "12", "Tokyo", table.iloc[20,8]],\
["ind", "2018", "12", "Tokyo", table.iloc[21,8]],\
["oth", "2018", "12", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "1", "Tokyo", table.iloc[19,8]],\
["com", "2019", "1", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "1", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "1", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "2", "Tokyo", table.iloc[19,8]],\
["com", "2019", "2", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "2", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "2", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "3", "Tokyo", table.iloc[19,8]],\
["com", "2019", "3", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "3", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "3", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "4","Tokyo", table.iloc[19,8]],\
["com", "2019", "4", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "4", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "4", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "5", "Tokyo", table.iloc[19,8]],\
["com", "2019", "5", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "5", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "5", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "6", "Tokyo", table.iloc[19,8]],\
["com", "2019", "6", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "6", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "6", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "7", "Tokyo", table.iloc[19,8]],\
["com", "2019", "7", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "7", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "7", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "8", "Tokyo", table.iloc[19,8]],\
["com", "2019", "8", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "8", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "8", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "9", "Tokyo", table.iloc[19,8]],\
["com", "2019", "9", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "9", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "9", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "10", "Tokyo", table.iloc[19,8]],\
["com", "2019", "10", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "10", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "10", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "11", "Tokyo", table.iloc[19,8]],\
["com", "2019", "11", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "11", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "11", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2019", "12", "Tokyo", table.iloc[19,8]],\
["com", "2019", "12", "Tokyo", table.iloc[20,8]],\
["ind", "2019", "12", "Tokyo", table.iloc[21,8]],\
["oth", "2019", "12", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "1", "Tokyo", table.iloc[19,8]],\
["com", "2020", "1", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "1", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "1", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "2", "Tokyo", table.iloc[19,8]],\
["com", "2020", "2", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "2", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "2", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "3", "Tokyo", table.iloc[19,8]],\
["com", "2020", "3", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "3", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "3", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "4", "Tokyo", table.iloc[19,8]],\
["com", "2020", "4", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "4", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "4", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "5", "Tokyo", table.iloc[19,8]],\
["com", "2020", "5", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "5", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "5", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "6", "Tokyo", table.iloc[19,8]],\
["com", "2020", "6", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "6", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "6", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "7", "Tokyo", table.iloc[19,8]],\
["com", "2020", "7", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "7", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "7", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "8", "Tokyo", table.iloc[19,8]],\
["com", "2020", "8", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "8", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "8", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "9", "Tokyo", table.iloc[19,8]],\
["com", "2020", "9", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "9", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "9", "Tokyo", table.iloc[22,8]]]
...
table=pd.read_excel(file_path,sheet_name=sheetName)
data = [["res", "2020", "10", "Tokyo", table.iloc[19,8]],\
["com", "2020", "10", "Tokyo", table.iloc[20,8]],\
["ind", "2020", "10", "Tokyo", table.iloc[21,8]],\
["oth", "2020", "10", "Tokyo", table.iloc[22,8]]]
...
data = [["res", "2020", "11", "Tokyo", table.iloc[18,10]],\
["com", "2020", "11", "Tokyo", table.iloc[19,10]],\
["ind", "2020", "11", "Tokyo", table.iloc[20,10]],\
["oth", "2020", "11", "Tokyo", table.iloc[21,10]]]
...
# CDD
table = pandas.read_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Weather Seasonality\Japan Weather\Tokyo CDD.csv')
table.columns = ['date','CDD', 'Other']
Output2 = pd.merge(Output2, table, how = 'inner', on = "date")
Output2 = Output2.drop(['Other'], axis = 1)

# HDD
table = pandas.read_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Weather Seasonality\Japan Weather\Tokyo HDD.csv',  error_bad_lines=False)
...
x = sm.add_constant(Output2.iloc[:,6:18]) #生成自变量
y = Output2['value']
model = sm.OLS(y, x)
result = model.fit()
result.summary()
